...
const projectView = (project) => {
    ...
    addToDoButton.addEventListener('click', () =>{
        ...
        const toDoView = (0,_todoView__WEBPACK_IMPORTED_MODULE_1__.creaetToDoView)(newToDo, project.getToDos().length);
        const removeButton = (0,_dom__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)('button','remove-todo-button');
